...
return [_c('a',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.linkClass(category, {isActive: isActive, isExactActive: isExactActive}),attrs:{"href":href,"role":"menuitem"},on:{"click":function($event){return _vm.onCategoryClick($event, category, navigate)},"keydown":function($event){return _vm.onCategoryKeydown($event, category)}}},[(category.icon)?_c('span',{class:_vm.getCategoryIcon(category)}):_vm._e(),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(_vm.label(category)))])])]}}],null,true)}):_c('a',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.linkClass(category),attrs:{"href":category.url,"target":category.target,"role":"menuitem","aria-haspopup":category.items != null,"aria-expanded":category === _vm.activeItem,"tabindex":_vm.disabled(category) ? null : '0'},on:{"click":function($event){return _vm.onCategoryClick($event, category)},"keydown":function($event){return _vm.onCategoryKeydown($event, category)}}},[(category.icon)?_c('span',{class:_vm.getCategoryIcon(category)}):_vm._e(),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(_vm.label(category)))]),(category.items)?_c('span',{class:_vm.getCategorySubMenuIcon()}):_vm._e()]),(category.items)?_c('div',{staticClass:"p-megamenu-panel"},[_c('div',{staticClass:"p-megamenu-grid"},_vm._l((category.items),function(column,columnIndex){return _c('div',{key:_vm.label(category) + '_column_' + columnIndex,class:_vm.getColumnClassName(category)},_vm._l((column),function(submenu,submenuIndex){return _c('ul',{key:_vm.label(submenu) + '_submenu_' + submenuIndex,staticClass:"p-megamenu-submenu",attrs:{"role":"menu"}},[_c('li',{class:_vm.getSubmenuHeaderClass(submenu),style:(submenu.style),attrs:{"role":"presentation"}},[_vm._v(_vm._s(_vm.label(submenu)))]),_vm._l((submenu.items),function(item,i){return [(_vm.visible(item) && !item.separator)?_c('li',{key:_vm.label(item) + i,class:_vm.getSubmenuItemClass(item),style:(item.style),attrs:{"role":"none"}},[(item.to && !_vm.disabled(item))?_c('router-link',{attrs:{"to":item.to,"custom":""},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var navigate = ref.navigate;
var href = ref.href;
var isActive = ref.isActive;
var isExactActive = ref.isExactActive;
return [_c('a',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.linkClass(item, {isActive: isActive, isExactActive: isExactActive}),attrs:{"href":href,"role":"menuitem"},nativeOn:{"click":function($event){return _vm.onLeafClick($event, item, navigate)}}},[(item.icon)?_c('span',{class:['p-menuitem-icon', item.icon]}):_vm._e(),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(_vm.label(item)))])])]}}],null,true)}):_c('a',{directives:[{name:"ripple",rawName:"v-ripple"}],class:_vm.linkClass(item),attrs:{"href":item.url,"target":item.target,"role":"menuitem","tabindex":_vm.disabled(item) ? null : '0'},on:{"click":function($event){return _vm.onLeafClick($event, item, _vm.navigate)}}},[(item.icon)?_c('span',{class:['p-menuitem-icon', item.icon]}):_vm._e(),_c('span',{staticClass:"p-menuitem-text"},[_vm._v(_vm._s(_vm.label(item)))]),(item.items)?_c('span',{class:_vm.getSubmenuIcon()}):_vm._e()])],1):_vm._e(),(_vm.visible(item) && item.separator)?_c('li',{key:'separator' + i,class:['p-menu-separator', item.class],style:(item.style),attrs:{"role":"separator"}}):_vm._e()]})],2)}),0)}),0)]):_vm._e()],1):_vm._e()]})],2),(_vm.$slots.end)?_c('div',{staticClass:"p-megamenu-end"},[_vm._t("end")],2):_vm._e()])}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/megamenu/MegaMenu.vue?vue&type=template&id=7ba247e8&
