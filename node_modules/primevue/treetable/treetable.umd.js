...
var FooterCellvue_type_template_id_6ec2433a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('td',{class:_vm.containerClass,style:(_vm.containerStyle)},[(_vm.column.children && _vm.column.children.footer)?_c('TTColumnSlot',{attrs:{"column":_vm.col}}):_vm._e(),_vm._v("\n    "+_vm._s(_vm.columnProp('footer'))+"\n")],1)}
...
var HeaderCellvue_type_template_id_3f68ee36_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('th',{class:_vm.containerClass,style:(_vm.containerStyle),attrs:{"tabindex":_vm.columnProp('sortable') ? '0' : null,"aria-sort":_vm.ariaSort},on:{"click":_vm.onClick,"keydown":_vm.onKeyDown}},[(_vm.resizableColumns && !_vm.columnProp('frozen'))?_c('span',{staticClass:"p-column-resizer",on:{"mousedown":_vm.onResizeStart}}):_vm._e(),(_vm.column.children && _vm.column.children.header)?_c('TTColumnSlot',{attrs:{"column":_vm.column}}):_vm._e(),(_vm.columnProp('header'))?_c('span',{staticClass:"p-column-title"},[_vm._v(_vm._s(_vm.columnProp('header')))]):_vm._e(),(_vm.columnProp('sortable'))?_c('span',{class:_vm.sortableColumnIcon}):_vm._e(),(_vm.isMultiSorted())?_c('span',{staticClass:"p-sortable-column-badge"},[_vm._v(_vm._s(_vm.getMultiSortMetaIndex() + 1))]):_vm._e()],1)}
...
var TreeTable_component = normalizeComponent(
  ...
  TreeTablevue_type_template_id_0492784c_render,
  staticRenderFns,
  false,
  null,
  null,
