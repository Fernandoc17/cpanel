...
"use strict";
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Dock_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("bd49");
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Dock_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Dock_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0__);
...
// load the styles
var content = __webpack_require__("e7ef");
if(content.__esModule) content = content.default;
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__("499e").default
var update = add("7629d807", content, true, {"sourceMap":false,"shadowMode":false});
...
return [_c('a',{directives:[{name:"tooltip",rawName:"v-tooltip:[tooltipOptions]",value:({value: item.label, disabled: !_vm.tooltipOptions}),expression:"{value: item.label, disabled: !tooltipOptions}",arg:_vm.tooltipOptions}],class:_vm.linkClass(item, {isActive: isActive, isExactActive: isExactActive}),attrs:{"href":href,"role":"menuitem","target":item.target},on:{"click":function($event){return _vm.onItemClick($event, item, navigate)}}},[(typeof item.icon === 'string')?[_c('span',{directives:[{name:"ripple",rawName:"v-ripple"}],class:['p-dock-action-icon', item.icon]})]:_c('DockSubIconTemplate',{attrs:{"icon":item.icon}})],2)]}}],null,true)}):_c('a',{directives:[{name:"tooltip",rawName:"v-tooltip:[tooltipOptions]",value:({value: item.label, disabled: !_vm.tooltipOptions}),expression:"{value: item.label, disabled: !tooltipOptions}",arg:_vm.tooltipOptions}],class:_vm.linkClass(item),attrs:{"href":item.url,"role":"menuitem","target":item.target,"tabindex":_vm.disabled(item) ? null : '0'},on:{"click":function($event){return _vm.onItemClick($event, item)}}},[(typeof item.icon === 'string')?[_c('span',{directives:[{name:"ripple",rawName:"v-ripple"}],class:['p-dock-action-icon', item.icon]})]:_c('DockSubIconTemplate',{attrs:{"icon":item.icon}})],2)]],2)}),0)])}
...
// EXTERNAL MODULE: ./src/components/dock/Dock.vue?vue&type=style&index=0&lang=css&
var Dockvue_type_style_index_0_lang_css_ = __webpack_require__("bc3d");
